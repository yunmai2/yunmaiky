...
@InputType()
class HubitusCheckupCreateNestedManyWithoutUsersInput {
...
export { HubitusCheckupCreateNestedManyWithoutUsersInput as HubitusCheckupCreateNestedManyWithoutUsersInput };
